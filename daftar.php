...
if (isset($_POST['daftar'])) {
    ...
    $insert = mysqli_query($koneksi, "INSERT INTO pendaftaran(nik, nama, email, hp, gender, alamat, pendidikan, id_jurusan, id_gelombang, tahun_pendaftaran)
        VALUES('$nik','$nama','$email','$hp','$gender','$alamat','$pendidikan', '$id_jurusan', '$id_gelombang', '$tahun_pendaftaran')");
    if ($insert) {
        // redirect
                                    ...
                                    <form class="user" method="post">
                                        ...
                                        <div class="form-group">
                                            <select name="id_gelombang" id="" class="form-control">
                                                ...
                                                <?php
                                                $queryGelombang = mysqli_query($koneksi, "SELECT * FROM gelombang");
                                                ?>
                                                <?php while ($dataGelombang = mysqli_fetch_assoc($queryGelombang)) { ?>
                                                <option value="<?php echo $dataGelombang['id'] ?>">
                                                    <?php echo $dataGelombang['nama_gelombang'] ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
